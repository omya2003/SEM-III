...
void blackjack::executeGame(){
	unsigned int time_seed = time(0); //get a random number
	srand(time_seed); //seeding the random number
	player user; //create a player called user
